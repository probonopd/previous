...
static SGOBJ memorydlg[] =
{
	...
	{ SGTEXT, 0, 0, 4,3, 12,1, "(not used yet 64Mb):" },
	{ SGRADIOBUT, 0, 0, 18,4, 9,1, "dummy" },
	{ SGRADIOBUT, 0, 0, 18,5, 7,1, "dummy" },
	{ SGRADIOBUT, 0, 0, 18,6, 7,1, "dummy" },
	{ SGRADIOBUT, 0, 0, 29,4, 7,1, "dummy" },
	{ SGRADIOBUT, 0, 0, 29,5, 7,1, "dummy" },
	{ SGRADIOBUT, 0, 0, 29,6, 8,1, "dummy" },

	{ SGBOX, 0, 0, 1,9, 38,10, NULL },
	{ SGTEXT, 0, 0, 12,10, 17,1, "Memory state save (untested)" },
