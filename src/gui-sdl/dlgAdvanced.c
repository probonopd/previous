...
static SGOBJ advanceddlg[] =
{
    ...
    { SGRADIOBUT, 0, 0, 4,6, 13,1, "68030" },
    { SGRADIOBUT, 0, 0, 4,8, 13,1, "68040" },
    { SGRADIOBUT, 0, 0, 4,10, 13,1, "68060" },
    
    { SGBOX, 0, 0, 17,3, 14,13, NULL },
    { SGTEXT, 0, 0, 18,4, 14,1, "CPU clock" },
    { SGRADIOBUT, 0, 0, 19,6, 13,1, "16 MHz" },
    { SGRADIOBUT, 0, 0, 19,8, 13,1, "20 MHz" },
    { SGRADIOBUT, 0, 0, 19,10, 13,1, "25 MHz" },
    { SGRADIOBUT, 0, 0, 19,12, 13,1, "33 MHz" },
    { SGRADIOBUT, 0, 0, 19,14, 13,1, "40 MHz" },
    
    { SGBOX, 0, 0, 32,3, 23,13, NULL },
    { SGTEXT, 0, 0, 33,4, 14,1, "FPU type" },
    { SGRADIOBUT, 0, 0, 34,6, 13,1, "68881" },
    { SGRADIOBUT, 0, 0, 34,8, 13,1, "68882" },
    { SGRADIOBUT, 0, 0, 34,10, 13,1, "68040 internal" },
    
    { SGBOX, 0, 0, 2,17, 18,7, NULL },
    { SGTEXT, 0, 0, 3,18, 14,1, "SCSI controller" },
    { SGRADIOBUT, 0, 0, 4,20, 13,1, "NCR53C90" },
    { SGRADIOBUT, 0, 0, 4,22, 13,1, "NCR53C90A" },
    
    { SGBOX, 0, 0, 21,17, 16,7, NULL },
    { SGTEXT, 0, 0, 22,18, 14,1, "RTC chip" },
    { SGRADIOBUT, 0, 0, 23,20, 13,1, "MC68HC68T1" },
    { SGRADIOBUT, 0, 0, 23,22, 13,1, "MCS1850" },
