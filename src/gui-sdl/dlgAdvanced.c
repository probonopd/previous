...
#define DLGADV_16MHZ      12
#define DLGADV_20MHZ      13
#define DLGADV_25MHZ      14
#define DLGADV_33MHZ      15
#define DLGADV_40MHZ      16

#define DLGADV_SCSI_OLD   19
#define DLGADV_SCSI_NEW   20

#define DLGADV_RTC_OLD    23
#define DLGADV_RTC_NEW    24

#define DLGADV_EXIT       25


static SGOBJ advanceddlg[] =
{
    { SGBOX, 0, 0, 0,0, 45,23, NULL },
    { SGTEXT, 0, 0, 11,1, 14,1, "Advanced system options" },
    ...
    { SGTEXT, 0, 0, 16,4, 12,1, "CPU clock" },
    { SGRADIOBUT, 0, 0, 17,6, 8,1, "16 MHz" },
    { SGRADIOBUT, 0, 0, 17,8, 8,1, "20 MHz" },
    { SGRADIOBUT, 0, 0, 17,10, 8,1, "25 MHz" },
    { SGRADIOBUT, 0, 0, 17,12, 8,1, "33 MHz" },
    { SGRADIOBUT, 0, 0, 17,14, 8,1, "40 MHz" },
    
    { SGBOX, 0, 0, 28,3, 15,7, NULL },
    { SGTEXT, 0, 0, 29,4, 14,1, "SCSI chip" },
    { SGRADIOBUT, 0, 0, 30,6, 10,1, "NCR53C90" },
    { SGRADIOBUT, 0, 0, 30,8, 11,1, "NCR53C90A" },
    
    { SGBOX, 0, 0, 28,11, 15,7, NULL },
    { SGTEXT, 0, 0, 29,12, 14,1, "RTC chip" },
    { SGRADIOBUT, 0, 0, 30,14, 12,1, "MC68HC68T1" },
    { SGRADIOBUT, 0, 0, 30,16, 10,1, "MCCS1850" },
    
    { SGBUTTON, SG_DEFAULT, 0, 11,20, 23,1, "Back to system menu" },
    { -1, 0, 0, 0,0, 0,0, NULL }
};
